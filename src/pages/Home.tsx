...
export default function Home() {
  ...
  return (
    <section className="mx-auto w-full max-w-[760px] pb-16 pt-14 sm:pb-24 sm:pt-24">
      ...
      <div className="mt-16">
        <div className="mb-5 border-b border-[#c5ccd3]/50 dark:border-white/10 pb-3">
          ...
          <>
            ...
            <div className="mt-7 text-center">
              <button
                ...
                className="text-xs text-[#6f8190] dark:text-[#8b949e] transition hover:text-[#2f556a] dark:hover:text-[#72a5c0] focus:outline-none focus:ring-2 focus:ring-[#72a5c0] disabled:opacity-60"
              >
                {loadingRandom
                  ? "Finding a thought…"
                  : "Read a random thought →"}
              </button>
            </div>
          </>
        )}
