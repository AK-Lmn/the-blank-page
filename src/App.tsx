...
const router = createBrowserRouter([{ path: "/", Component: AppLayout, children: [{ index: true, Component: Home }, { path: "write", Component: Write }, { path: "entry/:id", Component: Entry }, { path: "history", Component: History }] }])
