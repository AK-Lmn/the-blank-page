...
export default function Header() {
  const navLinkClass = ({ isActive }: { isActive: boolean }) =>
    `inline-flex min-h-11 items-center rounded-full border px-3 py-2 text-sm backdrop-blur-md transition-all focus:outline-none focus:ring-2 focus:ring-[#72a5c0] sm:px-4 ${
      isActive
