...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between gap-2 py-6 sm:gap-4 sm:py-9">
      ...
      >
        <span className="font-display block text-[1.25rem] leading-none tracking-[-0.04em] text-[#141a1f] sm:text-[1.45rem]">
          The Blank Page
        </span>
        <span className="mt-1 hidden text-[0.66rem] font-medium uppercase tracking-[0.18em] text-[#596773] min-[360px]:block">
